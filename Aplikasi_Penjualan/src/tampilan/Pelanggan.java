...
public class Pelanggan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rlaki.setFont(new java.awt.Font("Perpetua Titling MT", 0, 12)); // NOI18N
        rlaki.setText("Laki - Laki");

        rperempuan.setFont(new java.awt.Font("Perpetua Titling MT", 0, 12)); // NOI18N
        rperempuan.setText("Perempuan");

        bsimpan.setBackground(new java.awt.Color(153, 255, 255));
        bsimpan.setFont(new java.awt.Font("Perpetua Titling MT", 1, 10)); // NOI18N
        bsimpan.setText("Simpan");

        bubah.setBackground(new java.awt.Color(153, 255, 255));
        bubah.setFont(new java.awt.Font("Perpetua Titling MT", 1, 10)); // NOI18N
        bubah.setText("Ubah");

        bhapus.setBackground(new java.awt.Color(153, 255, 255));
        bhapus.setFont(new java.awt.Font("Perpetua Titling MT", 1, 10)); // NOI18N
        bhapus.setText("Hapus");

        bbatal.setBackground(new java.awt.Color(153, 255, 255));
        bbatal.setFont(new java.awt.Font("Perpetua Titling MT", 1, 10)); // NOI18N
        bbatal.setText("Batal");

        bkeluar.setBackground(new java.awt.Color(153, 255, 255));
        bkeluar.setFont(new java.awt.Font("Perpetua Titling MT", 1, 10)); // NOI18N
        bkeluar.setText("Keluar");

        jLabel7.setFont(new java.awt.Font("Perpetua Titling MT", 0, 12)); // NOI18N
        jLabel7.setText("Data Pelanggan");

        bcari.setFont(new java.awt.Font("Perpetua Titling MT", 0, 10)); // NOI18N
        bcari.setText("Cari");

        tblplgn.setFont(new java.awt.Font("Perpetua Titling MT", 0, 10)); // NOI18N
